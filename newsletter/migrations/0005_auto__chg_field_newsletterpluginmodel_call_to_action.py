...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NewsletterPluginModel.call_to_action'
        db.alter_column(u'newsletter_newsletterpluginmodel', 'call_to_action', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'NewsletterPluginModel.call_to_action'
        db.alter_column(u'newsletter_newsletterpluginmodel', 'call_to_action', self.gf('django.db.models.fields.TextField')(default=''))
