...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsletterPluginModel.call_to_action'
        db.add_column(u'newsletter_newsletterpluginmodel', 'call_to_action',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsletterPluginModel.call_to_action'
        db.delete_column(u'newsletter_newsletterpluginmodel', 'call_to_action')
