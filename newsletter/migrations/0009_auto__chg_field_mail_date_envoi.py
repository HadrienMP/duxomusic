...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mail.date_envoi'
        db.alter_column(u'newsletter_mail', 'date_envoi', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Mail.date_envoi'
        db.alter_column(u'newsletter_mail', 'date_envoi', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        u'newsletter.mail': {
            ...
            'date_creation': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_envoi': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_modification': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
