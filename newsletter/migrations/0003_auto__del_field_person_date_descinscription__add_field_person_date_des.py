...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Person.date_descinscription'
        db.delete_column(u'newsletter_person', 'date_descinscription')

        # Adding field 'Person.date_desinscription'
        db.add_column(u'newsletter_person', 'date_desinscription',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Person.date_descinscription'
        db.add_column(u'newsletter_person', 'date_descinscription',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Person.date_desinscription'
        db.delete_column(u'newsletter_person', 'date_desinscription')
